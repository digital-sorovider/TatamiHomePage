    ...
    <div>
        ...
        <div className='subtitle-content'>
          <p>
            ...
            2. アドミンは、オーナーが認めた、当サーバーを中心となってまとめる者を指す。オーナーもアドミンに含む。<br />
            3. 運営は、オーナーやアドミンが認めた、当サーバーの開発や建築等の制作をする者を指す。オーナー、アドミンも運営に含む。<br />
        ...
        <Subtitle subtitle="第3条 運営の権利と義務"/>
        <div className='subtitle-content'>
          <p>
            1. 運営は運営Discord・内部用Wiki・建築用のBuildサーバー に参加する権利を有する。<br />
            2. 運営のうち、広報を担当する者には、ブログ、SNS、動画格納ドライブ 等に参加する権利を付与することがある。<br />
            3. 畳サーバーに関する相談や質問がDMや身内鯖で来た際は、公平な判断や証拠確保のため、#サポートチケットへ誘導すること<br />
            4. マップの不備や破壊の痕、不具合等を確認したら、速やかに担当部署に報告すること。<br />
            5. 当サーバーに関するやり取りは、原則DMではなく各プロジェクトや部署のチャンネルを使用することとする。
          </p>
        </div>
        ...
        <Subtitle subtitle="第5条　個人情報の取り扱いと対応"/>
        <div className='subtitle-content'>
          <p>
            1. 運営は個人のプライバシー、名誉、その他第三者の権利を侵害することのないよう、<br />　利用者に関する情報の取扱に、十分配慮すること。<br />
            　特にサーバー管理班とモデレーター班は業務上取扱が必要になるため、厳重な管理を行うこと。<br />
            2. サーバーに大きな影響を及ぼしかねない事象が発生した場合は、<br />　 所属班によらず、 運営全員の総意をもって決定するものとする。<br />
            　 特に、鯖民の永久BANに該当しそうな場合は、現行犯を除き、運営の総意をもって決定するものとする。<br />
          </p>
        </div>

        <Subtitle subtitle="第6条 運営の禁止行為"/>
        <div className='subtitle-content'>
          <p>
            1. 運営はサーバー情報や個人情報などを外部に漏洩してはならない。これは運営脱退後でも適用される。<br />
        ...
        <Subtitle subtitle="第7条 ペナルティと剥奪"/>
        <div className='subtitle-content'>
          <p>
