...
const Contact = () => {
  ...
  const topicCheckboxes = [
    ...
    'ミニゲーム鯖について',
    '配信について',
    '畳サーバー公式特典サービス(Tebex)について',
    '配布マップ「マイクラスコットランドヤード」について',
    '配布マップ「マイクラバカ人狼」について',
    '配布マップ「マイクラモダンアート」について',
    '畳サーバー 運営へのご希望について',
  ]
    ...
    <div>
      ...
      <div className='subtitle-content'>
        <div className={Style["Contact-contents-wrapper"]}>
          <p>
            畳サーバーに関するご質問・ご提案・ご要望等を受け付けております。<br />
            匿名での送信も可能ですので、お気軽にお問い合わせください。<br />
            返信をご希望の方は、メールアドレスをご記載ください。<br />
            また、Discordでのやり取りをご希望の場合は、<br />
            <span className={Style["bold"]}>＃サポートチケット</span>
            をご利用ください。
          </p>
            ...
            <div className={Style["Input-item"]}>
              ...
              {errors['entry-1718713665'] && <sapn className={Style["error-mesege"]}>※お問い合わせの内容をご記入ください</sapn>}
                ...
                id="inquiry-details"
                  ...
                  <p>※画像や動画のアップロードを希望される場合は、Discordの #サポートチケット チャンネルまでお願いします。</p>
              </div>
            </div>
      ...
      <UpArrow />
      <Igusa text="ここでは畳サーバーに対してお問い合わせを送信することができるわ。
      メールアドレスを持たない方や、画像・動画を掲載したい方は、
      Discordの #サポートチケット を使ってね。"
        image={Sister1}
        creator="ナミヤ 和 様"
      />
    </div>
