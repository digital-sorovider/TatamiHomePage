...
const Help = () => {
  ...
  const QuestionList=[
    ...
    },
    {
      ...
      answer:<>ご安心ください。当サーバーにはコマンドの練習ができる&quot;データパック研修&quot;という制度がございます。<br/>3週間に分けて無理なく楽しみながら進めることができるので、初学者でも安心です!</>,
    },
    {
      question:"絶対に参加しなければならない日はありますか？", 
      answer:<>2024年9月現在、毎月1回、進捗確認と情報共有のためのミーティングを開催しています。<br/>
